export default function About() {
  return (
    <div className="relative z-10 h-screen flex items-center px-6 md:px-16 text-[#333]">
      <div className="max-w-2xl text-left font-sirenia">
        <h2 className="text-3xl md:text-4xl font-semibold">Wat kan therapie voor jou betekenen?</h2>
        ...
        <blockquote className="bg-[#fff6f0] text-sm md:text-base italic rounded-md shadow-md px-4 py-3 mt-6">
